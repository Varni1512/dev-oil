...
const PrivacyPolicy = () => {
  ...
  <div>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14 bg-white">
        <h1
        ...
        <div className="mt-8 md:mt-10 bg-white/90 backdrop-blur-sm rounded-xl shadow-sm p-5 sm:p-7 md:p-10">
